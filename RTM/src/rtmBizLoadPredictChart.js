Ext.define('rtm.src.rtmBizLoadPredictChart', {
    ...
    init: function() {
        ...
        this.chart = EXEM.cls.create('XMAiChart', {
            ...
            titleClickEvent: function() {
                this.openStatList(this.title, this.bizId);
            }.bind(this),
    ...
    setTitle: function(title, bizId, bizName) {
        this.title   = title;
        this.bizId   = bizId;
        this.bizName = bizName;

        if (this.chart != null) {
            this.chart.titleLayer.setTitle(title + ' (' + bizName + ')');
        }
    },

    openStatList: function(statName, id) {
        this.listWindow = Ext.create('rtm.src.rtmBizLoadPredictStatList', {
            style: {'z-index': '10'}
        });

        this.listWindow.bizId       = id;
