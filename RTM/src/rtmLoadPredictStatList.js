Ext.define('rtm.src.rtmLoadPredictStatList', {
    ...
    listeners: {
        show : function() {
            ...
            wasRow = this.wasGrid.getStore().findRecord('Name', this.wasId);
    ...
    findStatValue: function() {
        ...
        this.wasId = this.searchWasNameCombo.getValue();
