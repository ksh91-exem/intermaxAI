Ext.define('rtm.src.rtmDashLoadPredictMCA', {
    ...
    queryRefresh: function() {
        ...
        $.ajax({
            url  : '../service/' + folder + '/graph_mca_was_' + this.wooriPocDataFolder + '.json',
        ...
        $.ajax({
            url  : '../service/' + folder + '/graph_mca_db_' + this.wooriPocDataFolder + '.json',
            success: function(data) {
        ...
        $.ajax({
            url  : '../service/' + folder + '/graph_mca_os_' + this.wooriPocDataFolder + '.json',
            success: function(data) {
