Ext.define('rtm.src.rtmDBAnomalyDetectionStatList', {
    extend   : 'rtm.src.rtmAnomalyDetectionStatList',
    ...
    addList : function() {
        ...
        for (ix = 0, ixLen = realtime.anoDetectionDBStatList.length; ix < ixLen; ix++ ) {
            statName = realtime.anoDetectionDBStatList[ix].id;
            display  = common.Util.TR(realtime.anoDetectionDBStatList[ix].name);
