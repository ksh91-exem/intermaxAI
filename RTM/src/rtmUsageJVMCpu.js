Ext.define('rtm.src.rtmUsageJVMCpu',{
    extend: 'Exem.DockForm',
    title : common.Util.CTR('JVM CPU Usage'),
    layout: 'fit',
    ...
    initProperty: function() {
        ...
        this.title = common.Util.CTR('JVM CPU Usage');

        this.envKeyChartFit = 'rtm_' + this.monitorType.toLocaleLowerCase() + '_usage_jvm_CpuChart_fit';
    ...
    initLayout: function() {
        ...
        this.barChart.onAlarm = function(adata) {
            ...
            if (alertName === realtime.alarms.JVM_CPU && +adata[1] === 1) {
