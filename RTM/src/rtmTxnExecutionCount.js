Ext.define('rtm.src.rtmTxnExecutionCount', {
    extend: 'Exem.DockForm',
    title : common.Util.CTR('Today Transaction Execution Count'),
    layout: 'fit',
    width : '100%',
    height: '100%',
    ...
    initLayout: function() {
        ...
        this.frameTitle = Ext.create('Ext.form.Label',{
            ...
            padding: '0 0 0 0',
            cls    : 'header-title',
            text   : common.Util.CTR('Today Transaction Execution Count')
        });
    ...
    drawChartData: function() {
        ...
        WS.SQLExec({
            sql_file: 'IMXRT_ServiceStat_ExecutionCount.sql',
            bind: [{
            ...
            if ( !common.Util.checkSQLExecValid(header, data) ) {
                console.debug('rtmTxnExecutionCount.js - drawChartData()');
