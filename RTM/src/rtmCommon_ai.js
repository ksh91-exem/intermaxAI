Ext.define('rtm.src.rtmCommon', {
    ...
    getDockLayer: function(type) {
        ...
        switch (type) {
            ...
            case 'TuxMonitor':
                ...
                break;
            case 'AIMonitor':
                layer = '[{"defaultFrameVersion":"' + this.layoutVersion.AI + '", "cls":"Ext.container.Container","layout":"vbox","flex":1,"items":[{"cls":"rtm.src.rtmAlertInfo","layout":"fit","flex":50,"items":[],"frameOption":null},{"cls":"Ext.container.Container","layout":"vbox","flex":820,"items":[{"cls":"Ext.container.Container","layout":"hbox","flex":210,"items":[{"cls":"rtm.src.rtmDBLoadPredict","layout":"fit","flex":478,"items":[],"frameOption":null,"componentId":"rtm-ext-7921-cmp"},{"cls":"Ext.container.Container","layout":"hbox","flex":1016,"items":[{"cls":"rtm.src.rtmDBLoadPredict","layout":"fit","flex":506,"items":[],"frameOption":null,"componentId":"rtm-ext-8385-cmp"},{"cls":"rtm.src.rtmDBLoadPredict","layout":"fit","flex":505,"items":[],"frameOption":null,"componentId":"rtm-ext-8288-cmp"}],"frameOption":null}],"frameOption":null},{"cls":"Ext.container.Container","layout":"vbox","flex":605,"items":[{"cls":"Ext.container.Container","layout":"vbox","flex":422,"items":[{"cls":"Ext.container.Container","layout":"hbox","flex":197,"items":[{"cls":"rtm.src.rtmLoadPredict","layout":"fit","flex":478,"items":[],"frameOption":null,"componentId":"rtm-ext-7552-cmp"},{"cls":"Ext.container.Container","layout":"hbox","flex":1016,"items":[{"cls":"rtm.src.rtmLoadPredict","layout":"fit","flex":506,"items":[],"frameOption":null,"componentId":"rtm-ext-7573-cmp"},{"cls":"rtm.src.rtmDBLoadPredict","layout":"fit","flex":505,"items":[],"frameOption":null,"componentId":"rtm-ext-8095-cmp"}],"frameOption":null}],"frameOption":null},{"cls":"Ext.container.Container","layout":"hbox","flex":220,"items":[{"cls":"rtm.src.rtmTxnLoadPredict","layout":"fit","flex":478,"items":[],"frameOption":null,"componentId":"rtm-ext-4254-cmp"},{"cls":"Ext.container.Container","layout":"hbox","flex":1016,"items":[{"cls":"rtm.src.rtmTxnLoadPredict","layout":"fit","flex":506,"items":[],"frameOption":null,"componentId":"rtm-ext-4341-cmp"},{"cls":"rtm.src.rtmTxnLoadPredict","layout":"fit","flex":505,"items":[],"frameOption":null,"componentId":"rtm-ext-4428-cmp"}],"frameOption":null}],"frameOption":null}],"frameOption":null},{"cls":"Ext.container.Container","layout":"hbox","flex":178,"items":[{"cls":"rtm.src.rtmTxnLoadPredict","layout":"fit","flex":480,"items":[],"frameOption":null,"componentId":"rtm-ext-4515-cmp"},{"cls":"Ext.container.Container","layout":"hbox","flex":1014,"items":[{"cls":"rtm.src.rtmTxnLoadPredict","layout":"fit","flex":504,"items":[],"frameOption":null,"componentId":"rtm-ext-4800-cmp"},{"cls":"rtm.src.rtmTxnLoadPredict","layout":"fit","flex":505,"items":[],"frameOption":null,"componentId":"rtm-ext-4887-cmp"}],"frameOption":null}],"frameOption":null}],"frameOption":null}],"frameOption":null}],"frameOption":null}]';
                break;
            default:
                break;
        }
    ...
    checkChangeDefaultLayout: function() {
        ...
        // 현재 기본 화면을 구성하는 정보를 가져오기
        var saveData = Comm.RTComm.getDockLayer('RealtimeMonitor3');
