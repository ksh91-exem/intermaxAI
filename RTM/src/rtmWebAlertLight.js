Ext.define('rtm.src.rtmWebAlertLight', {
    ...
    initAlarmList: function() {
        ...
        var ix, ixLen;
        var serverKeys = Object.keys(Comm.webServersInfo);
    ...
    isSkipAlarm: function(serverType, serverName) {
        return serverType !== 3 || !this.alarmLevelList[serverName];
    },
    ...
    checkAlarmByServerType: function() {
        ...
        var serverList = Repository.alarmListInfo.WebServer;
