Ext.define('rtm.src.rtmServiceStatTrendChart', {
    ...
    drawData: function(data) {
        ...
        if (this.parent.setMaxValueLabel != null) {
            ...
            this.parent.setMaxValueLabel(yMax, tMax);
        }
    },


    openStatList: function(statname) {
        this.listWindow = Ext.create('rtm.src.rtmServiceStatList', {
            style: {'z-index': '10'}
        });

        this.listWindow.statName     = statname;
        this.listWindow.oldStatName  = Comm.RTComm.getStatIdByName(statname);
        this.listWindow.targetChart  = this;
        this.listWindow.isTotal      = (this.isTotal)? this.isTotal : false;
