Ext.define('rtm.src.rtmTPAlertLight', {
    ...
    initAlarmList: function() {
        ...
        var ix, ixLen;
        var serverKeys = Object.keys(Comm.tpInfoObj);

        for (ix = 0, ixLen = serverKeys.length; ix < ixLen; ix++) {
            this.alarmLevelList[Comm.tpInfoObj[serverKeys[ix]].name] = {};
        }
    },
    ...
    setServerList: function() {
        ...
        for (ix = 0, ixLen = serverKeys.length; ix < ixLen; ix++) {
            ...
            nameArr[nameArr.length] = Comm.tpInfoObj[serverKeys[ix]].name;
