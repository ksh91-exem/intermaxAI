Ext.define('rtm.src.rtmTierTrendChart', {
    ...
    init: function() {
        ...
        this.chart = EXEM.cls.create('XMTrendChart', {
            ...
            title    : this.title,
            titleHeight: 24,
            titleClass : 'performance-title auto-cursor',
            showLegend : false,
            toFixedNumber: 0,
            chartProperty: {
                crosshair : {
    ...
    /**
     * 더블 클릭 시 선택된 구간에 트랜잭션 상세 정보를 보여주는 팝업창 표시
     */
    setDblClickEvent: function() {
        this.chart.chartContainer.addEventListener('dblclick', function(e) {
            ...
            this.parent.openTxnDetail(index);
