Ext.define('rtm.src.rtmDashLoadPredictStatList', {
    ...
    addList : function() {
        ...
        for (ix = 0, ixLen = realtime.dashLoadPredictStatList.length; ix < ixLen; ix++ ) {
            statName = realtime.dashLoadPredictStatList[ix].id;
            display  = common.Util.TR(realtime.dashLoadPredictStatList[ix].name);
