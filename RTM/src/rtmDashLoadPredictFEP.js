Ext.define('rtm.src.rtmDashLoadPredictFEP', {
    ...
    queryRefresh: function() {
        ...
        $.ajax({
            url  : '../service/' + folder + '/graph_fep_was_' + this.wooriPocDataFolder + '.json',
        ...
        $.ajax({
            url  : '../service/' + folder + '/graph_fep_db_' + this.wooriPocDataFolder + '.json',
            success: function(data) {
        ...
        $.ajax({
            url  : '../service/' + folder + '/graph_fep_os_' + this.wooriPocDataFolder + '.json',
            success: function(data) {
