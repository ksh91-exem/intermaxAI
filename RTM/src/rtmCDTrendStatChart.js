Ext.define('rtm.src.rtmCDTrendStatChart', {
    ...
    openStatList: function(statname) {
        this.listWindow = Ext.create('rtm.src.rtmCDStatList', {
            style: {'z-index': '10'}
        });

        this.listWindow.statName     = statname;
        this.listWindow.oldStatName  = Comm.RTComm.getCDStatIdByName(statname);
