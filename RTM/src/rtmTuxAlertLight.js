Ext.define('rtm.src.rtmTuxAlertLight', {
    ...
    initAlarmList: function() {
        ...
        var ix, ixLen;
        var serverKeys = Object.keys(Comm.tuxInfoObj);

        for (ix = 0, ixLen = serverKeys.length; ix < ixLen; ix++) {
            this.alarmLevelList[Comm.tuxInfoObj[serverKeys[ix]].name] = {};
        }
    },
    ...
    setServerList: function() {
        ...
        for (ix = 0, ixLen = serverKeys.length; ix < ixLen; ix++) {
            ...
            nameArr[nameArr.length] = Comm.tuxInfoObj[serverKeys[ix]].name;
