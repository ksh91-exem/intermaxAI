Ext.define('rtm.view.rtmEtoEView', {
    ...
    listeners: {
        ...
        show: function() {
            ...
            window.isLockRTMFrame = Comm.RTComm.getBooleanValue(Comm.web_env_info.rtm_e2e_frame_lock);
    ...
    createView: function() {
        ...
        this.hostList = Ext.Array.merge(Comm.hosts, realtime.TPHostList, realtime.TuxHostList, realtime.WebHostList, realtime.CDHostList);
    ...
    getTierInfo: function() {
        ...
        WS.SQLExec({
            ...
            var tierId, tierName, serverId, serverType, ix, ixLen;
