Ext.define('rtm.view.rtmAIView1', {
    ...
    createView: function() {
        ...
        if (this.rec === 'dashboard.dashAIMonitor1') {
            defaultLayer = Comm.RTComm.getDockLayer('AIMonitor1');
        } else if (this.rec === 'dashboard.dashAIMonitor2') {
            defaultLayer = Comm.RTComm.getDockLayer('AIMonitor2');
        }
