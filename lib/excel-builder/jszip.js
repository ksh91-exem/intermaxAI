...
JSZip.prototype = (function () {
   ...
   return {
      ...
      generateDataToBase64 : function(inputData){
          var result;

          result = JSZip.base64.encode(inputData);

          return result;
      },

       generateBase64ToData : function(inputData){
           var result;

           result = JSZip.base64.decode(inputData);
