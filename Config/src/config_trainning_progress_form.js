Ext.define('config.config_trainning_progress_form', {
    ...
    init: function (state) {
        ...
        this.grid.addColumn({text: common.Util.CTR('Agent') ,       dataIndex: 'was_name'     ,  width: 100, type: Grid.String      , alowEdit: false, editMode: false});
        ...
        this.grid.addRow(['A', 50]);
        this.grid.addRow(['B', 40]);
        this.grid.addRow(['C', 30]);
        this.grid.addRow(['D', 100]);
