Ext.define('config.config_trainning_auto_form', {
    ...
    init: function (state) {
        ...
        this.grid.addColumn({text: common.Util.CTR('자동학습 시작일') ,   dataIndex: 'was_name',  width: 120, type: Grid.String      , alowEdit: false, editMode: false});
        this.grid.addColumn({text: common.Util.CTR('자동학습 주기'),   dataIndex: 'was_id'  ,    width: 110, type: Grid.StringNumber, alowEdit: true, editMode: true});
        this.grid.addColumn({text: common.Util.CTR('자동학습 구간'),   dataIndex: 'was_id'  ,    width: 110, type: Grid.StringNumber, alowEdit: true, editMode: true});
        this.grid.endAddColumns();

        this.grid.addRow(['was', '7', '50']);
        this.grid.addRow(['db',  '6', '40']);
        this.grid.addRow(['os',  '3', '30']);
        this.grid.addRow(['e2e', '2', '100']);
