Ext.define('config.config_trainning_history_form', {
    ...
    init: function (state) {
        ...
        this.grid.addColumn({text: common.Util.CTR('학습시작 날짜') ,   dataIndex: 'was_name',    width: 120, type: Grid.String      , alowEdit: false, editMode: false});
        this.grid.addColumn({text: common.Util.CTR('학습종료 날짜'),   dataIndex: 'end_time'  ,    width: 110, type: Grid.String, alowEdit: false, editMode: false});
        this.grid.addColumn({text: common.Util.CTR('학습결과'),   dataIndex: 'result'        ,    width: 110, type: Grid.String, alowEdit: false, editMode: false});
        this.grid.addColumn({text: common.Util.CTR('세부결과'),   dataIndex: 'result_json'  ,    width: 110, type: Grid.String, alowEdit: false, editMode: false});
        this.grid.endAddColumns();

        this.grid.addRow(['2019-09-06', '2019-09-06', '성공', 'JSON']);
        this.grid.addRow(['2019-09-06', '2019-09-06', '성공', 'JSON']);
        this.grid.addRow(['2019-09-06', '2019-09-06', '성공', 'JSON']);
        this.grid.addRow(['2019-09-06', '2019-09-06', '성공', 'JSON']);
        this.grid.addRow(['2019-09-06', '2019-09-06', '성공', 'JSON']);
