 ...
 */
Ext.define("view.WebComparisonTrend",{
    ...
    get_chart_sql: function( type, date_obj ){
        ...
        try {
            ...
            if ( diff2 - diff1 >= 86400000 ) {
                sql_file = 'IMXPA_WebComparisonTrend_Chart_Agent_daily.sql';

            }
            else {
                sql_file = 'IMXPA_WebComparisonTrend_Chart_Agent.sql';
            }
    ...
    get_grid_data: function(){
        ...
        for ( var ix = 0; ix < Number(this.cbo_cnt.getRawValue()); ix++ ){
            ...
            this.array_grid[ix].up().setTitle( Comm.webServersInfo[this.stand_data[ix][2]].name ) ;
            this.array_grid[ix].up().up().el.dom.style.borderColor = color[ix] ;

            WS.SQLExec({
                sql_file: 'IMXPA_WebComparisonTrend_Grid.sql',
                bind: [{ name: 'fromtime', value: this.stand_data[ix][0], type : SQLBindType.STRING }
                    ...
                    ,{ name: 'ws_id', value: this.stand_data[ix][2], type : SQLBindType.INTEGER }]
            }, this.on_grid.bind({
    ...
    init: function(){
        ...
        this.IDXDB_STAT      = 'pa_web_comparison_stat';
        this.IDXDB_STAT_ID   = 'pa_web_comparison_stat_id';
        this.IDXDB_GC        = 'pa_web_comparison_gc';
        this.IDXDB_GC_ID     = 'pa_web_comparison_gc_id';
        this.IDXDB_LAST_TYPE = 'pa_web_comparison_last_type';
        this.IDXDB_TYPES     = 'pa_web_comparison_types';
    ...
    layout_top: function(){
        ...
        this.cbo_condition.addItem('3', common.Util.TR('WebServer') + '+' + common.Util.TR('Time')) ;
        this.cbo_condition.addItem('2', common.Util.TR('Time')) ;
        this.cbo_condition.addItem('1', common.Util.TR('WebServer')) ;
    ...
    layout_center: function(){
        ...
        if ( this.stat_change == undefined || this.stat_change == null ){
            ...
            setTimeout(function(){
                ...
                this.stat_view.view_name          = 'web_comparison' ;
