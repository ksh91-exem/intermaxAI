...
Ext.define('view.TPTrend', {
    ...
    wasStatRelSql: {
        ...
        mid_svr: ['tps', 'txn_cnt', 'txn_cnt_sum', 'q_cnt', 'q_cnt_sum', 'em_cnt_sum', 'qp_cnt_sum'],
        mid_svc: ['elapse', 'q_time', 'aq_cnt', 'aq_cnt_sum'],
        mid_proc: ['proc_cnt', 'fail_cnt', 'fail_cnt_sum', 'err_cnt', 'err_cnt_sum'],
        mid_client: ['client_cnt']
    },

    useDbCombo: false,
    gridEnvKey: 'pa_tp_performance_trend',

    initProperty: function() {
        var ix, ixLen,
            tabInfo, lastType;

        lastType = Comm.web_env_info['pa_tp_performance_trend_last_type'];
        ...
        this.sql.mid_was = 'IMXPA_TPTrend_Mid_WAS.sql';
        this.sql.mid_svr = 'IMXPA_TPTrend_Mid_SVR.sql';
        this.sql.mid_svc = 'IMXPA_TPTrend_Mid_SVC.sql';
        this.sql.mid_proc = 'IMXPA_TPTrend_Mid_Proc.sql';
        this.sql.mid_client = 'IMXPA_TPTrend_Mid_Client.sql';
        this.sql.bot_active = 'IMXPA_TPTrend_Bot_Active.sql';
    },
    ...
    addActiveColumns: function(grid) {
        ...
        grid.addColumn(common.Util.CTR('Bank Code'          )  , 'tx_code'       , 100, Grid.String       , true , false);
    ...
    setSessionGrid: function(data) {
        ...
        for (ix = 0, ixLen = data.rows.length; ix < ixLen; ix++) {
            ...
            wasId = rowData[22];
            hostName = Comm.tpInfoObj[wasId].host;
            ...
            grid.addRow([
                ...
                rowData[16],    //5
                rowData[17],    //text5
                rowData[18],    //sql_exec_count
                rowData[19],    //fetch_count
                rowData[20],    //time
                rowData[21],    //start time tmp
                wasId,          //was_id
                rowData[23],    //tid
                rowData[24],    //txn_id
                rowData[25]     //class_method
            ]);
        }
    ...
    openUserDefineWindow: function() {
        ...
        this.userDefineWindow = Ext.create('view.PerformanceTrendUserDefined', {
            ...
            view_name: 'tp_performance_trend',
            modal: true,
            scope: this
        });
