Ext.define('view.TuxElapseDistribution', {
    ...
    createLayoutDetailCond: function() {
        ...
        this.conditionArea.add([this.txnNameField, this.tidField, this.serverNameField, this.gidField]);
    },
    ...
    retrieve: function() {
        ...
        if (result) {
            ...
            if (this.opServerName == '%') {
                ...
                this._serverNameRepl = 'AND s.prog_name LIKE \'' + this.opServerName + '\'';
            }
