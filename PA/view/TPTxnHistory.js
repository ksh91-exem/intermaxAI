Ext.define("view.TPTxnHistory", {
    ...
    sql: {
        summary   : 'IMXPA_TPTxnHistory_summary.sql',
        gridClick : 'IMXPA_TPTxnHistory_gridClick.sql',
        txnElapse : 'IMXPA_TPTxnHistory_txnElapse.sql',
        sqlElapse : 'IMXPA_TPTxnHistory_sqlElapse.sql',
        txnDrag   : 'IMXPA_TPTxnHistory_txnDrag.sql',
        sqlDrag   : 'IMXPA_TPTxnHistory_sqlDrag.sql'
    },
    listeners: {
