 ...
 */
Ext.define("view.TPComparisonTrend",{
    ...
    get_chart_sql: function( type, date_obj ){
        ...
        try{
            ...
            if ( diff2 - diff1 >= 86400000 ){
                sql_file = 'IMXPA_TPComparisonTrend_Chart_Agent_daily.sql';
            }else{
                sql_file = 'IMXPA_TPComparisonTrend_Chart_Agent.sql';
            }
    ...
    init: function(){
       ...
       this.was_stat_alias = [
        ...
        this.IDXDB_STAT      = 'pa_tp_comparison_stat';
        this.IDXDB_STAT_ID   = 'pa_tp_comparison_stat_id';
        this.IDXDB_GC        = 'pa_tp_comparison_gc';
        this.IDXDB_GC_ID     = 'pa_tp_comparison_gc_id';
        this.IDXDB_LAST_TYPE = 'pa_tp_comparison_last_type';
        this.IDXDB_TYPES     = 'pa_tp_comparison_types';
    ...
    layout_center: function(){
        ...
        if ( this.stat_change == undefined || this.stat_change == null ){
            ...
            setTimeout(function(){
                ...
                this.stat_view.view_name          = 'tp_comparison' ;
