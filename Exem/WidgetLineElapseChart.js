Ext.define('Exem.WidgetLineElapseChart', {
    extend: 'Ext.Component',
    alias: 'widget.LineElapseChart',
    layout: 'fit',
    ...
    init: function(column, widget, record) {
        ...
        if(this.getEl()) {
            ...
            //             bizData = Repository.BizTrendDataLog[ix][jx].TXN_ELAPSE;
            //
            //             // console.dir(bizData);
            //             console.dir(bizData.join());
            //         }
            //     }
            // }
            // console.log('------------------');
            ...
            for(ix in Repository.BizTrendDataLog){
                for(jx in Repository.BizTrendDataLog[ix]){
                    ...
                    if(bizData.TREE_KEY.split('-').indexOf(String(rData.bizId)) !== -1){
                        data = bizData.TIME;
                        d = this.sumArray(d, bizData.TXN_ELAPSE);
                    }
                }
            }
